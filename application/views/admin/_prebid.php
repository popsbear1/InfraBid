  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>Pre-bid Conference <small>Approved Budget Cost above 1 Million</small></h2>
   ...
   <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM plan where ABC BETWEEN 1000000 AND 5000000") or die(mysql_error());
