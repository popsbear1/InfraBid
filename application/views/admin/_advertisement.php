  ...
  <?php include 'static\dashboard.html'; ?>
   ...
   <?php
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      $result1 = mysql_query("SELECT * from procact where project_no = '$id'") or die(mysql_error());
       
      while ($row1 = mysql_fetch_array($result1)) {

      if ($row1['pre_proc'] != '0000-00-00') {
          ...
          <a href='_addadver.php?id=".$row['project_no']."' class='shortcut'>
