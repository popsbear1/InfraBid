  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Cat <small></small></h2>
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewcatcompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editcat.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>No. of Dogs Owned (3 mos & above) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['cats3u']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>No. of Dogs Owned (below 3 mos.)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['cats3d']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteCat.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
