  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Swine <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM swine") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewswinecompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editswine.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Boar (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['boarN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Boar (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['boarU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Sows (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['sowN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Sow (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['sowU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Gilt (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['giltN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Gilt (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['giltU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Fattener / Finisher (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['fattenerN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Fattener / Finisher (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['fattenerU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Grower (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['growerN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Grower (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['growerU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Piglets (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['pigletN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Piglet (Upgrade)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['pigletU']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Of the total swine, how many are organic?</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['organic']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Slaughtered on Farm / Household (kg)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['slaughter']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteSwine.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
