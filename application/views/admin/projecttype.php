...
<html lang="en">
  ...
  <div class="form-group no-print">
                        <div class="col-md-3 col-sm-6 col-xs-6 col-md-offset-9">
                          <a href="addproject.php" type="button" class="btn btn-primary">Add New Project Type</a>
                 </div>
      </div>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM projtype") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='editproject.php?id=".$row['id']."' class='shortcut'>
