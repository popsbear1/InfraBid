...
<html lang="en">
  <?php include 'static\dashboard.html'; ?>
      ...
      <?php
            ...
            if(isset($_POST['submit']))
              {
                            ...
                            $query3= mysql_query("UPDATE projtype set type = '$type' where id='$id'");
       ...
       $query1=mysql_query("select * from projtype where id='$id'") or die(mysql_error());
                    ...
                    <form id="form" method="POST" data-parsley-validate class="form-horizontal form-label-left"onkeypress="return event.keyCode != 13;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" step="any"  id="type" value="<?php echo $row['type']; ?>" name="type"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        </div>
