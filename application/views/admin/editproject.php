    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Project Details<small></small></h2>
          ...
          <div class="x_content">
            ...
            <?php endif ?>
            <form id="editProjectForm" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url('admin/editProjectType') ?>">

              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Type of Project<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" step="any"  id="type" value="" name="type"  placeholder="<?php echo $projectTypeDetails['type'] ?>" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
