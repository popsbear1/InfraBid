...
<script>
  $(document).ready(function() {
    ...
    <div id="editProjectModal" class="modal fade" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" form="editProjectForm" name="submit" class="btn btn-primary">Confirm</button>
          </div>
        </div>
      </div>
    </div>
