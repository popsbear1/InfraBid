  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Weekly Average Consumption <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM hconsumption") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewconsumptioncompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editconsumption.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Beef (kg) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['beef']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Carabeef (kg)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['carabeef']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Pork (kg) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['pork']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Chicken (kg)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['chicken']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Fish (kg)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['fish']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Weekly Average Consumption of Egg (pcs)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['egg']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteConsumption.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
