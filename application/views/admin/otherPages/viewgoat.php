  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Goat <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM goat") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewgoatcompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editgoat.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Buck (Dairy) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['buckD']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Buck (Meat)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['buckM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Doe (Dairy) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['doeD']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Doe (Meat)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['doeM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Kids (Dairy) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['kidsD']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Kids (Meat)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['kidsM']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteGoat.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
