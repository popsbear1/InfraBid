  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Other Animals/Birds <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM other") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewothercompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editother.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Sheep (Male) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['sheepM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Sheep (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['sheepF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Horse (Male) </label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['horseM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Horse (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['horseF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Monkey (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['monkeyM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Monkey (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['monkeyF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Rabbit (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['rabbitM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Rabbit (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['rabbitF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Duck (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['duckM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Duck (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['duckF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Pigeon (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['pigeonM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Pigeon (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['pigeonF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Quail (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['quailM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Quail (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['quailF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Turkey (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['turkeyM']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Turkey (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['turkeyF']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Others (Male)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['others1M']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Others (Female)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['others1F']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteOther.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
