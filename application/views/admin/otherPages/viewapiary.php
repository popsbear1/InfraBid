  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Apiary <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM apiary") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewapiarycompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editapiary.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-success fa fa-edit'></a></td>";
      echo "<td style='text-align: center'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Number of Colonies</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['colonies']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Total Production of Honey in kg</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['production']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteApiary.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
