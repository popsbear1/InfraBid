<section class="content-header">
  <h2>Edit Account Classificaton Details</h2>
</section>
          ...
          <form id="editClassification" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url('admin/editClassification') ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" step="any"  id="className" value="" name="classification" placeholder="<?php echo $classification->classification ?>" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
