  ...
  <?php include 'static\dashboard.html'; ?>
      ...
      <?php
           ...
           if (isset($_POST['submit'])) {
                            ...
                            $query3= mysql_query("INSERT INTO funds(source)VALUES('$source'
                              )");
                    ...
                    <form id="form" method="POST" data-parsley-validate class="form-horizontal form-label-left"onkeypress="return event.keyCode != 13;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" step="any"  id="source" value="<?php echo date('Y');?>" name="source"  required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                        </div>
