                    ...
                    <form id="form" method="POST" data-parsley-validate class="form-horizontal form-label-left"onkeypress="return event.keyCode != 13;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          $query = mysql_query("SELECT * from municipalities") or die(mysql_error());
                            ...
                            ?>
                            <option value="<?php echo $row['municipality']." - ".$row['municipalitycode'] ?>"><?php echo $row['municipality']." - ".$row['municipalitycode']?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <?php
                          include 'databaseconnect.php';
                          $query = mysql_query("SELECT * from barangays") or die(mysql_error());
                            while ($row = mysql_fetch_array($query)) {
                            ?>
