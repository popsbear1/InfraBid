			...
			<div class="row">	
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
					<div class="form-group">
						<label>Project:</label>
						<p class="input-sm"><?php echo $projectDetails['project_no'] . ' - ' . $projectDetails['project_title'] ?></p>
					</div>
					<div class="form-group">
						<label>Location:</label>
						<p class="input-sm"><?php echo $projectDetails['barangay'] . ', ' . $projectDetails['municipality'] ?></p>
					</div>
					<div class="form-group">
						<label>Project Type:</label>
						<p class="input-sm"><?php echo $projectDetails['type'] ?></p>
					</div>
					<div class="form-group">
						<label>Procurement Mode:</label>
						<p class="input-sm"><?php echo $projectDetails['mode'] ?></p>
					</div>
					<div class="form-group">
						<label>ABC:</label>
						<p class="input-sm"><?php echo number_format($projectDetails['abc'], 2) ?></p>
					</div>
					<div class="form-group">
						<label>Source of Fund:</label>
						<p class="input-sm"><?php echo $projectDetails['source'] ?></p>
					</div>
					<div class="form-group">
						<label>Account Classification:</label>
						<p class="input-sm"><?php echo $projectDetails['classification'] ?></p>
					</div>
					<div class="form-group">
						<label>Abc/PPost Date:</label>
						<p class="input-sm"><?php 
