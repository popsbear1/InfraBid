  ...
  <?php include 'static\dashboard.html'; ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>View Data for Carabao <small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM carabao") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='viewcarabaocompletedetail.php?id=".$row['id']."' class='shortcut'>
      <i style='font-size: 20px' class='btn btn-info fa fa-file-text-o'></a></td>";
      echo "<td style='text-align: center'>
      <a href='editcarabao.php?id=".$row['id']."' class='shortcut'>
                    ...
                    <div class='modal-dialog modal-lg'>
                      <div class='modal-content'>
                        ...
                        <div class='modal-body'>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Carabull (Crossbreed)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['carabullC']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Carabull (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['carabullN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Caracow (Crossbreed)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['caracowC']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Caracow (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['caracowN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Male (Crossbreed)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['maleC']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Male (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['maleN']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Heifer</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['heifer']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Yearling (Crossbreed)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['yearlingC']."</p>
                                </div>
                                </div>
                                ...
                                <div class='form-group'>
                                <label class='control-label col-md-6 col-sm-6 col-xs-12'>Yearling (Native)</label>
                                <div class='col-md-6 col-sm-6 col-xs-12'>
                                    <p>".$row['yearlingN']."</p>
                                </div>
                                </div>
                        ...
                        <div class='modal-footer'>
                          <a href='deleteCarabao.php?id=".$row['id']."' class='btn btn-primary'>Yes</a>
