...
<html lang="en">
  ...
  <div class="form-group no-print">
                        <div class="col-md-3 col-sm-6 col-xs-6 col-md-offset-9">
                          <a href="addfund.php" type="button" class="btn btn-primary">Add New Fund</a>
                 </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                  <h2>Manage Funds<small></small></h2>
      ...
      <?php
                include 'databaseconnect.php';
                $result = mysql_query("SELECT * FROM funds") or die(mysql_error());
    ...
    while($row = mysql_fetch_array( $result )) {
      ...
      <a href='editfund.php?id=".$row['id']."' class='shortcut'>
