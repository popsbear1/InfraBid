...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      <h3 class="pull-left">Completed Document Tracking Monitoring Page</h3>
    </div>
  </div>
  <div class="box">
    <div class="box-header">
      <h2 class="box-title"><i class="fa fa-list"></i> Project Plan Records</h2>
      <small>(Listed here are those projects whith status of Completed, for review and for implementation.)</small>
    </div>
    <div class="box-body">
        ...
        <tbody>
          <?php foreach ($plans as $plan): ?>
            <tr>
              ...
              <td><?php echo $plan['proposed_bid'] ?></td>
