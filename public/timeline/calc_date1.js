		...
		function calc_date1() {
			...
			if(dateArray[2].length<4){
				...
				odate.setDate(odate.getDate() - 28)
				...
				odate1.setDate(odate1.getDate() -21)
				...
				odate2.setDate(odate2.getDate() - 20)
				...
				odate3.setDate(odate3.getDate() - 20)
				...
				odate6.setDate(odate6.getDate() - 7)
				...
				odate7.setDate(odate7.getDate() - 7)
				...
				odate8.setDate(odate8.getDate() - 6)
				...
				odate9.setDate(odate9.getDate() - 6)
				...
				odate10.setDate(odate10.getDate() - 5)
				...
				odate13.setDate(odate13.getDate() - 2)
				document.f2.date_to13.value=("0" + odate13.getDate()).slice(-2) + '/' +("0" + (odate13.getMonth() + 1)).slice(-2) + '/' +  odate13.getFullYear()

				odate14 = new Date(sdate.getTime() + (days * 86400000))
				odate14.setDate(odate14.getDate() - 1)
				document.f2.date_to14.value=("0" + odate14.getDate()).slice(-2) + '/' +("0" + (odate14.getMonth() + 1)).slice(-2) + '/' +  odate14.getFullYear()

				odate15 = new Date(sdate.getTime() + (days * 86400000))
				odate15.setDate(odate15.getDate() - 1)
				document.f2.date_to15.value=("0" + odate15.getDate()).slice(-2) + '/' +("0" + (odate15.getMonth() + 1)).slice(-2) + '/' +  odate15.getFullYear()

				odate16 = new Date(sdate.getTime() + (days * 86400000))
				odate16.setDate(odate16.getDate() + 0 )
				document.f2.date_to16.value=("0" + odate16.getDate()).slice(-2) + '/' +("0" + (odate16.getMonth() + 1)).slice(-2) + '/' +  odate16.getFullYear()

				odate17 = new Date(sdate.getTime() + (days * 86400000))
				odate17.setDate(odate17.getDate() + 0)
				document.f2.date_to17.value=("0" + odate17.getDate()).slice(-2) + '/' +("0" + (odate17.getMonth() + 1)).slice(-2) + '/' +  odate17.getFullYear()
