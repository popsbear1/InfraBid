...
document.forms[0].group20.checked='';
document.forms[0].group21.checked='checked';
document.forms[0].group22.checked='';
...
if((document.f2.group11.checked=='') && (document.f2.group12.checked!='') && (document.f2.group15.checked!='') && (document.f2.group16.checked=='')){  
...
odate14.setDate(odate14.getDate() + 164)
...
odate15.setDate(odate15.getDate() + 164)
...
odate16.setDate(odate16.getDate() + 171)
...
odate17.setDate(odate17.getDate() + 171)
document.f2.date_to17.value=("0" + (odate17.getMonth() + 1)).slice(-2) + '/' +  ("0" + odate17.getDate()).slice(-2) + '/' +  odate17.getFullYear()

}

else if((document.f2.group15.checked=='') && (document.f2.group16.checked!='') && (document.f2.group11.checked!='') && (document.f2.group12.checked=='')){ 
