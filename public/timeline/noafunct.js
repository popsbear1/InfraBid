	...
	function noafunct() {
		...
		s=document.f2.date_to10.value
		days=(document.f2.noa1.value*1)//-1
		...
		//}
			...
			odate.setDate(odate.getDate() -23)
			...
			odate1.setDate(odate1.getDate() -16)
			...
			odate2.setDate(odate2.getDate() -15)
			...
			odate3.setDate(odate3.getDate() - 15)
			...
			odate4.setDate(odate4.getDate() - 3)
			...
			odate5.setDate(odate5.getDate() - 3)
			...
			odate8.setDate(odate8.getDate() - 1)
			...
			odate9.setDate(odate9.getDate() - 1)
			...
			odate10.setDate(odate10.getDate() - 0)
