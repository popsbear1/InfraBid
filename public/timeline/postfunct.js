	function postfunct() {
		...
		//}
		...
		else if(document.f2.evaltxt1.value!="") {

			odate8 = new Date(sdate.getTime() - (days * 86400000))
			odate8.setDate(odate8.getDate() - 0)
			...
			odate.setDate(odate.getDate() -22)
			...
			odate1.setDate(odate1.getDate() -15)
			...
			odate2.setDate(odate2.getDate() -14)
			...
			odate3.setDate(odate3.getDate() - 14)
			...
			odate4.setDate(odate4.getDate() - 2)
			...
			odate5.setDate(odate5.getDate() - 2)
