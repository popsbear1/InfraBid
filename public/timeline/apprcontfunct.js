	...
	function apprcontfunct() {

		s=document.f2.date_to14.value
		...
		//}
			...
			odate.setDate(odate.getDate() -27)
			...
			odate2.setDate(odate2.getDate() -19)
			...
			odate3.setDate(odate3.getDate() - 19)
			...
			odate4.setDate(odate4.getDate() - 7)
			...
			odate5.setDate(odate5.getDate() - 7)
			...
			odate6.setDate(odate6.getDate() - 6)
			...
			odate7.setDate(odate7.getDate() - 6)
			...
			odate8.setDate(odate8.getDate() - 5)
			...
			odate9.setDate(odate9.getDate() - 5)
			...
			odate12.setDate(odate12.getDate() - 2)
			...
			odate13.setDate(odate13.getDate() - 1)
			...
			odate14.setDate(odate14.getDate() + 0)
