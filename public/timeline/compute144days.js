function compute144days() {

s=document.f2.sTextBox.value
days=0;

 document.forms[0].prebid1.disabled=true;
  document.forms[0].prebidadded.disabled=true;
  document.forms[0].evaltxt1.disabled=true;
   document.forms[0].postqual1.disabled=true;
    document.forms[0].noa1.disabled=true;
	 document.forms[0].consign.disabled=true;
	  document.forms[0].apprcont.disabled=true;
	   document.forms[0].noticeproc.disabled=true;
  ...
  document.forms[0].evaltxt1.value="";
   document.forms[0].postqual1.value="";
    document.forms[0].noa1.value="";
	 ...
	 document.forms[0].group22.checked='checked';
...
if ((document.f2.group20.checked=='') && (document.f2.group21.checked=='') && (document.f2.group22.checked!='') && (document.f2.group11.checked=='') && (document.f2.group12.checked!='')  && (document.f2.group15.checked!='') && (document.f2.group16.checked=='')) {
...
odate14.setDate(odate14.getDate() + 179)
...
odate15.setDate(odate15.getDate() + 179)
...
odate16.setDate(odate16.getDate() + 186)
...
odate17.setDate(odate17.getDate() + 186)
document.f2.date_to17.value=("0" + (odate17.getMonth() + 1)).slice(-2) + '/' +  ("0" + odate17.getDate()).slice(-2) + '/' +  odate17.getFullYear()

}

else if ((document.f2.group11.checked=='') && (document.f2.group12.checked!='') && (document.f2.group15.checked=='') && (document.f2.group16.checked!='')) {
...
else if ((document.f2.group20.checked=='') && (document.f2.group21.checked=='') && (document.f2.group22.checked!='') && (document.f2.group11.checked!='') && (document.f2.group12.checked=='') && (document.f2.group15.checked=='') && (document.f2.group16.checked!='')) {
