...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 19, 2018 at 02:21 AM
...
CREATE TABLE IF NOT EXISTS `funds` (
  ...
  `fund_type` enum('regular','supplementary') NOT NULL,
...
INSERT INTO `funds` (`fund_id`, `fund_type`, `source`, `status`) VALUES
(1, 'regular', 'PSB', 'active'),
(2, 'regular', 'Calamity Fund', 'active'),
(3, 'regular', 'GF', 'active'),
(4, 'regular', 'Trust', 'active'),
(5, 'regular', 'PRDP', 'active'),
(6, 'regular', 'SLRF', 'active'),
(7, 'regular', 'PAMANA', 'active'),
(8, 'regular', 'PRNDP', 'active'),
(9, 'regular', 'DOE', 'active'),
(10, 'regular', 'SEF', 'active'),
(11, 'regular', 'CHARMP', 'active'),
(12, 'regular', 'Supplemental Budget', 'active'),
(13, 'regular', 'Other Funds', 'active'),
(14, 'regular', '20% PDF', 'active'),
(15, 'regular', 'asd', 'active'),
(16, 'regular', 'asd', 'active'),
(17, 'regular', '123', 'active');
...
(1, '', 'send', 1, '2018-07-18 17:23:11'),
(2, 'addawdawdawd', 'send', 1, '2018-07-18 19:28:41'),
(3, 'addawdawdawd', 'send', 1, '2018-07-18 19:28:41'),
(4, 'addawdawdawd', 'send', 1, '2018-07-18 19:28:41'),
(5, 'addawdawdawd', 'send', 1, '2018-07-18 19:28:41'),
(6, 'addawdawdawd', 'send', 1, '2018-07-18 19:28:41'),
(7, NULL, 'receive', 4, '2018-07-19 08:43:41'),
(8, NULL, 'receive', 4, '2018-07-19 08:44:37'),
(9, NULL, 'receive', 4, '2018-07-19 08:44:37'),
(10, NULL, 'receive', 4, '2018-07-19 08:44:37'),
(11, NULL, 'receive', 4, '2018-07-19 08:44:37'),
(12, NULL, 'receive', 4, '2018-07-19 08:44:37');
...
(1, 1, 43, 1, 'BAC_SEC', 'BAC_TWG', NULL, 'received', ''),
(2, 1, 1, 1, 'BAC_SEC', 'BAC_TWG', NULL, 'received', ''),
(3, 1, 2, 1, 'BAC_SEC', 'BAC_TWG', NULL, 'received', ''),
(4, 1, 10, 1, 'BAC_SEC', 'BAC_TWG', NULL, 'received', ''),
(5, 1, 11, 1, 'BAC_SEC', 'BAC_TWG', NULL, 'received', '');
...
(1, 23223, 'Bridge over the sky', 2018, NULL, 4, 25, 2, 1, 7, 1, '5000000.00', 'pending', NULL, '2018-07-18', NULL);
