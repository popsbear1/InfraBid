...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 29, 2018 at 09:35 PM
...
(1, '2018-08-26', '2018-08-27', '2018-09-04', '2018-09-16', '2018-09-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(1, 'finished', 'finished', 'finished', 'finished', 'finished', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending'),
(2, 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending'),
...
INSERT INTO `project_observers` (`activity_observer`, `plan_id`, `observer_id`, `name_of_observer`, `activity_name`, `invite_date`) VALUES
(1, 1, 1, '', 'pre_bid', '2018-08-29 13:13:07'),
(2, 1, 1, 'Reuel Bigo', 'eligibility', '2018-08-29 13:29:43'),
(3, 1, 1, 'Jayson Caliway', 'sub_open', '2018-08-29 13:30:31'),
(4, 1, 2, 'Ronnel Bigo', 'bid_evaluation', '2018-08-29 13:31:04');
...
CREATE TABLE IF NOT EXISTS `project_plan` (
  ...
  `pre_bid_invite_date` datetime DEFAULT NULL,
  `eligibility_check_invite_date` datetime DEFAULT NULL,
  `sub_open_invite_date` datetime DEFAULT NULL,
  `bid_evaluation_invite_date` datetime DEFAULT NULL,
  `post_qual_invite_date` datetime DEFAULT NULL,
  `delivery_completion_invite_date` datetime DEFAULT NULL,
  PRIMARY KEY (`plan_id`),
...
(1, 'HTH_666', 'Highway to Hell', 2018, 'regular', 1, 7, 16, 1, 2, 1, 5000000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'onprocess', 0, '2018-08-27', 'true', '2018-08-27 02:22:31', NULL, NULL, '2018-08-29 21:13:07', '2018-08-29 21:29:43', '2018-08-29 21:30:31', '2018-08-29 21:31:04', NULL, NULL),
(2, 'STH-999', 'Stairway to Heaven', 2018, 'regular', 1, 7, 16, 1, 2, 1, 5000000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'onprocess', 0, '2018-08-27', 'true', '2018-08-27 02:22:42', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'TOB_8898', 'Tower of Babelon', 2018, 'regular', 1, 8, 16, 1, 2, 1, 900000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'pending', 0, '2018-08-29', 'false', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'set', NULL, '2018-08-27', '2018-09-03', '2018-09-04', '2018-09-04', '2018-09-16', '2018-09-16', '2018-09-17', '2018-09-17', '2018-09-18', '2018-09-18', '2018-09-19', '2018-09-19', '2018-09-20', '2018-09-20', '2018-09-21', '2018-09-21', '2018-09-22', '2018-09-22'),
