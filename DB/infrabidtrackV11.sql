...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 11, 2018 at 11:32 AM
...
(1, 'Hilands Builders Association', 'Reuel Martinez Bigo', 'Pusel Amgaleygey Buguias Benguet', '09260878700'),
(2, 'Ijy Bangir nga kasjy', 'Ni isu na', 'ijy banda metlang ijy', '090901893');
...
INSERT INTO `document_type` (`doc_type_id`, `doc_no`, `document_name`) VALUES
(1, 1, 'Notice To Proceed'),
(2, 2, 'Contract'),
(3, 3, 'Performance Bond'),
(4, 4, 'Notice of Award'),
(5, 5, 'Notice of Post Qualifications'),
(6, 6, 'Resolution of Award');
...
INSERT INTO `logs` (`log_id`, `remark`, `forwarded_by`, `forwarded_to`, `receiver`, `forward_date`, `received_date`) VALUES
(1, 'goodbye', 'mr.bigo', 'departmanet', 'mr.cals', '2018-07-05 22:16:07', '2018-07-05 22:16:07');
...
(10, '2018-07-05', NULL, NULL, '2018-07-11', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '2018-07-09', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
INSERT INTO `project_plan` (`plan_id`, `project_no`, `project_title`, `municipality_id`, `barangay_id`, `projtype_id`, `mode_id`, `fund_id`, `account_id`, `abc`, `status`, `re_bid_count`, `date_added`, `contractor_id`) VALUES
(3, 17002, 'La Trinidad Bridge', 9, 85, 2, 2, 11, 2, '14000000.00', 'pending', NULL, '2017-07-03', NULL),
(4, 17003, 'Mankayan Road', 10, 104, 9, 2, 12, 1, '55000000.00', 'processing', 1, '2018-07-03', NULL),
(5, 17004, 'Tublay Farm Roads', 13, 134, 8, 2, 9, 1, '5492000.00', 'pending', NULL, '2018-07-03', NULL),
(6, 17005, 'Mankayan Farm', 10, 98, 2, 1, 14, 2, '10000000.00', 'pending', NULL, '2018-07-03', NULL),
(7, 17006, 'Coldchain', 2, 11, 3, 1, 14, 2, '15000000.00', 'pending', NULL, '2018-07-03', NULL),
(8, 17007, 'Bridge Reconstruction', 12, 127, 8, 1, 2, 1, '4353000.00', 'pending', NULL, '2018-07-03', NULL),
(9, 17008, 'Road Rehabilitation', 4, 27, 3, 2, 11, 1, '8454000.00', 'pending', NULL, '2018-07-03', NULL),
(10, 9923, 'School Building for Saganduy Elementary School', 4, 25, 5, 1, 4, 1, '5000000.00', 'processing', 1, '2018-07-04', 2);
