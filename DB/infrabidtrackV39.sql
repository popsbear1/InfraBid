...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 25, 2018 at 07:02 AM
...
(1, 'DILG', 'active'),
(2, 'COA', 'active'),
(3, 'PICE Representative', 'active'),
(4, 'PICPA Repricentative', 'active');
...
(1, '2018-08-08', '2018-08-23', '2018-09-09', '2018-09-21', '2018-09-21', '2018-09-22', '2018-09-23', '2018-09-24', NULL, NULL, NULL, NULL, NULL),
(2, NULL, '2018-08-23', '2018-08-31', '2018-09-12', '2018-09-12', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, '2018-08-31', NULL, '2018-09-08', '2018-09-08', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'finished', 'finished', 'finished', 'finished', 'finished', 'finished', 'finished', 'finished', 'pending', 'pending', 'pending', 'pending', 'pending'),
(2, 'not_needed', 'finished', 'finished', 'finished', 'finished', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending'),
(3, 'not_needed', 'finished', 'not_needed', 'finished', 'finished', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending', 'pending');
...
CREATE TABLE IF NOT EXISTS `project_bidders` (
  ...
  `bid_status` enum('disqualifide','active') NOT NULL DEFAULT 'active',
...
(1, 1, 2, 4000000.00, 'active'),
(2, 1, 3, 4999999.00, 'active'),
(3, 1, 1, 3000000.00, 'active'),
(4, 2, 2, 4999999.00, 'active'),
(5, 2, 3, 3999999.00, 'active'),
(6, 2, 1, 2999999.00, 'active');
...
(1, 1, 37, 2, NULL, 'PEO', NULL, 'received', 'false'),
(2, 1, 38, 2, NULL, 'PEO', NULL, 'received', 'false'),
(3, 1, 39, 2, NULL, 'PEO', NULL, 'received', 'false'),
(4, 1, 40, 2, NULL, 'PEO', NULL, 'received', 'false'),
(5, 1, 41, 2, NULL, 'PEO', NULL, 'received', 'false'),
(6, 1, 42, 2, NULL, 'PEO', NULL, 'received', 'false'),
(7, 1, 43, 2, NULL, 'PEO', NULL, 'received', 'false'),
(8, 2, 37, 2, NULL, 'PEO', NULL, 'received', 'false'),
(9, 2, 38, 2, NULL, 'PEO', NULL, 'received', 'false'),
(10, 2, 39, 2, NULL, 'PEO', NULL, 'received', 'false'),
(11, 2, 40, 2, NULL, 'PEO', NULL, 'received', 'false'),
(12, 2, 41, 2, NULL, 'PEO', NULL, 'received', 'false'),
(13, 2, 42, 2, NULL, 'PEO', NULL, 'received', 'false'),
(14, 2, 43, 2, NULL, 'PEO', NULL, 'received', 'false'),
(15, 3, 37, 2, NULL, 'PEO', NULL, 'received', 'false'),
(16, 3, 38, 2, NULL, 'PEO', NULL, 'received', 'false'),
(17, 3, 39, 2, NULL, 'PEO', NULL, 'received', 'false'),
(18, 3, 40, 2, NULL, 'PEO', NULL, 'received', 'false'),
(19, 3, 41, 2, NULL, 'PEO', NULL, 'received', 'false'),
(20, 3, 42, 2, NULL, 'PEO', NULL, 'received', 'false'),
(21, 3, 43, 2, NULL, 'PEO', NULL, 'received', 'false');
...
CREATE TABLE IF NOT EXISTS `project_plan` (
  ...
  `sub_open_invite_date` int(11) DEFAULT NULL,
  `bid_evaluation_invite_date` int(11) DEFAULT NULL,
  `post_qual_invite_date` int(11) DEFAULT NULL,
  `delivery_completion_invite_date` int(11) DEFAULT NULL,
  PRIMARY KEY (`plan_id`),
...
(1, 'HTH_666', 'Highway to Hell', 2018, 'regular', 1, 7, 16, 1, 2, 1, 5000000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'onprocess', 0, '2018-08-23', 'true', '2018-08-23 08:14:31', 1, 3000000.00, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'STH_999', 'Stairway to Heaven', 2018, 'regular', 1, 7, 16, 1, 2, 1, 2000000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'onprocess', 0, '2018-08-23', 'true', '2018-08-23 08:15:37', 1, 2999999.00, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'TOB_8847AD', 'Tower of Babelon', 2018, 'regular', 1, 8, 16, 1, 2, 1, 500000.00, 'Aug-2018', 'Sep-2018', 'Oct-2018', 'Nov-2018', 'onprocess', 0, '2018-08-23', 'true', '2018-08-23 08:16:21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'set', NULL, '2018-08-31', '2018-09-07', '2018-09-09', '2018-09-09', '2018-09-21', '2018-09-21', '2018-09-22', '2018-09-22', '2018-09-23', '2018-09-23', '2018-09-24', '2018-09-24', '2018-09-25', '2018-09-25', '2018-09-26', '2018-09-26', '2018-09-27', '2018-09-27'),
(2, 'set', NULL, '2018-08-23', '2018-08-30', '2018-08-31', '2018-08-31', '2018-09-12', '2018-09-12', '2018-09-13', '2018-09-13', '2018-09-14', '2018-09-14', '2018-09-15', '2018-09-15', '2018-09-16', '2018-09-16', '2018-09-17', '2018-09-17', '2018-09-18', '2018-09-18'),
(3, 'set', NULL, '2018-08-31', '2018-09-07', NULL, NULL, '2018-09-08', '2018-09-08', '2018-09-09', '2018-09-09', '2018-09-10', '2018-09-10', '2018-09-11', '2018-09-11', '2018-09-12', '2018-09-12', '2018-09-13', '2018-09-13', '2018-09-14', '2018-09-14');
